...
insert into compras values ("c1", "juanjozv", "2017-01-17", "123456789", 1000, "666");
insert into compras values ("c2", "juanjozv", "2017-01-17", "123456789", 2000, "666");
insert into compras values ("c3", "juanjozv", "2017-01-17", "123456789", 3000, "666");
insert into compras values ("c4", "Danirys16", "2017-01-17", "696969696", 4000, "777");	
insert into compras values ("c5", "Danirys16", "2017-01-17", "696969696", 5000,"777");
insert into compras values ("c6", "Danirys16", "2017-01-17", "696969696", 6000,"777");
insert into compras values ("c7", "Kim.olivas", "2017-01-17", "777888999", 7000,"888");
insert into compras values ("c8", "Kim.olivas", "2017-01-17", "777888999", 8000, "888");	
insert into compras values ("c9", "Kim.olivas", "2017-01-17", "777888999", 9000,"888");

-- Tiquetes para viaje 1
insert into tiquete values ("1", "Celso Borges", "1", "A1", "c1");
insert into tiquete values ("2", "Jonathan McDonald", "1", "A2", "c1");
insert into tiquete values ("3", "Keylor Navas", "1", "B2", "c2");
insert into tiquete values ("4", "Daniela Armas", "1", "B3", "c2");
insert into tiquete values ("5", "Kimberly Olivas", "1", "C1", "c3");
insert into tiquete values ("6", "JuanJo Zaldívar", "1", "C2", "c3");

-- Tiquetes para viaje 2
insert into tiquete values ("7", "Bryan Ulloa", "2", "B8", "c4");
insert into tiquete values ("8", "Jorge Barquero", "2", "C7", "c5");
insert into tiquete values ("9", "Madelyn Marie", "2", "E10", "c6");
insert into tiquete values ("10", "Alexis Texas", "2", "F10", "c7");
insert into tiquete values ("11", "Mia Khalifa", "2", "E5", "c8");
insert into tiquete values ("12", "Luis Ramírez", "2", "E6", "c9");
